...
func ConnectDatabase(app string) {
	...
	dbHost := os.Getenv("DB_HOST_ADK")
	dbPort := os.Getenv("DB_PORT_ADK")
	dbDatabase := os.Getenv("DB_DATABASE_ADK")
	dbUsername := os.Getenv("DB_USERNAME_ADK")
	dbPassword := os.Getenv("DB_PASSWORD_ADK")
