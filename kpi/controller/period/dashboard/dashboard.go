...
func DashboardPeriodKpi(w http.ResponseWriter, r *http.Request) {
	...
	query := fmt.Sprintf("SELECT yearmonth, label FROM dashboard.sp_filter('admin', '%s|period', 'kpi')", page)
